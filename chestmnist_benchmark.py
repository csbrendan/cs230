...
# a dataset comprising 112,120 frontal-view X-Ray images of 30,805 unique patients with the text-mined 14 disease labels, 
# which could be formulized as a multi-label binary-class classification task. We use the official data split, 
# and resize the source images of 1×1024×1024 into 1×28×28.
...
#save model to disk
#PATH = 'test_models/breastmnist_test.pth'
torch.save(model_ft.state_dict(), 'benchmark_resnet18_chestmnist_15epoch.pth')   #was model.

#not reco, but you can save entire model
#torch.save(model, 'test_models/breastmnist_test.pth')
